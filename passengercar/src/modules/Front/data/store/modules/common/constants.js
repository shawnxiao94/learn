...
// 是否显示tagsViews
export const SHOWTAGSVIEWS = `${BASEFLAG}_SHOWTAGSVIEWS`
// 是否显示全屏按钮
export const FULLSCREEN = `${BASEFLAG}_FULLSCREEN`
// 左上边是否显示折叠菜单功能按钮
export const SHOWHAMBURGER = `${BASEFLAG}_SHOWHAMBURGER`
// 设置菜单导航模式
export const MENUMODE = `${BASEFLAG}_MENUMODE`
