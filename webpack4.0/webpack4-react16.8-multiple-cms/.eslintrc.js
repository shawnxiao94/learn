/*
 * @Author: your name
 * @Date: 2019-12-30 16:30:20
 * @LastEditTime : 2020-01-19 14:01:08
 * @LastEditors  : Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \webpack4-react16.8-multiple-cms\.eslintrc.js
 */
module.exports = {
	// 作用的目录是根目录
	root: true,	
    ...
    "arrow-parens": 0,
		...
		"no-param-reassign": 1, // 函数传递的参数允许改变使用但会警告
		"no-nested-ternary": 1, // 允许使用嵌套的三元表达式，但是会警告
		// 对JSX的规范警告进行放行
