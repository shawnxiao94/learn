/**
  ...
  * author: Emma
  * update: 注释 by Emma 2019-10-11 15:00:00
  */
import React, { PureComponent } from 'react'
import TableGroup from '@/components/UI/TableGroup'
import filters from '@/common/filters'
import ActivityButton from './Button/index.js'
    ...
    return (
      <TableGroup>
        <Table
          ...
          scroll={{ x: 1400 }}
        >
          <Column title='活动名称' width='240px' dataIndex='markName' key='markName' />
          <Column
            title='营销渠道'
          ...
          />
          <Column title='状态' width='220px' dataIndex='status' key='status'
            render={values => (
