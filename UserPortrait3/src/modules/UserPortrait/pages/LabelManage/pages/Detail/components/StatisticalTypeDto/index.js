...
const { Column } = Table
class StatisticalTypeDto extends Component {
  constructor(props) {
    super(props)
  }
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <dl>
          <dt>标签规则</dt>
          <dd>
            {detailData.tagRuleDtos ? detailData.tagRuleDtos.map((item, index) => {
              return (
                <span key={index}>
                  {item.tagRuleName}
                </span>
...
export default StatisticalTypeDto