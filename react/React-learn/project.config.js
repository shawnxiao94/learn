...
module.exports = {
    ...
    publicPath: NODE_ENV === 'development' ? './' : 'http://127.0.0.1:8080/',
    esLint: true,
    relative: false,
    vendor: ['react', 'react-dom', 'react-router-dom', 'react-loadable', 'mobx', 'mobx-react', 'crypto-js', 'js-cookie', 'axios','mockjs','moment','react-live-route','throttle-debounce']
}
